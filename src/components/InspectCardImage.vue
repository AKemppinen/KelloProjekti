<template>
  ...
  <figure class="bg-highlight relative w-screen lg:w-1/2 2xl:w-2/5 4xl:w-1/3 xl:shrink-0">
    <figcaption class="text-lightgrey">
      ...
      <div class="absolute mt-auto h-fit lg:flex lg:flex-col lg:justify-end 2xl:flex-none bottom-8 lg:top-0 2xl:top-auto 2xl:bottom-16 inset-x-0 mx-auto w-2/3 text-center">
