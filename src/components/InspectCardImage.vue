<template>
  ...
  <figure class="bg-highlight relative w-screen lg:w-1/2 2xl:w-2/5 4xl:w-1/3 xl:shrink-0 border border-highlight">
    <transition mode="out-in" name="faceChange">
      <img v-if="faceFront" class="h-screen 2xl:h-full pb-32 pt-8 sm:pt-16 lg:pb-56 lg:pt-24 mx-auto object-contain 2xl:object-cover" :src="require('@/assets/watchfaces/' + cardImageData.id + '/front.png')" :alt="cardImageData.Reference">
